...
namespace HangManG.DataLayer
{
    public class HangmanConnection
    {
        ...
        {
            List<Profile> profiles = connection.Query<Profile>("Select * from Profile Order by Lost  Desc");
            return profiles;
        }

        public List<Profile> GetWinnerProfile()
        {
            List<Profile> profiles = connection.Query<Profile>("Select * from Profile Order by Won Desc");
            return profiles;
        }
